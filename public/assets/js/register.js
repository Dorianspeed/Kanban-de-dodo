const app = {
    ...
    addListenerToActions: () => {
        ...
        document.querySelector('form').addEventListener('submit', app.handleRegisterForm);
    },

    handleRegisterForm: async (event) => {
        try {
            ...
            let response = await fetch (app.base_url + '/users', {
                method: 'POST',
                body: data
            });
